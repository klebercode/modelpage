...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enterprise.logo'
        db.add_column(u'core_enterprise', 'logo',
                      self.gf('filebrowser.fields.FileBrowseField')(default=0, max_length=200),
                      keep_default=False)

        # Adding field 'Enterprise.logo_trans'
        db.add_column(u'core_enterprise', 'logo_trans',
                      self.gf('filebrowser.fields.FileBrowseField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enterprise.logo'
        db.delete_column(u'core_enterprise', 'logo')

        # Deleting field 'Enterprise.logo_trans'
        db.delete_column(u'core_enterprise', 'logo_trans')
