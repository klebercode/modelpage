...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enterprise.url_trans'
        db.add_column(u'core_enterprise', 'url_trans',
                      self.gf('django.db.models.fields.URLField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enterprise.url_trans'
        db.delete_column(u'core_enterprise', 'url_trans')
